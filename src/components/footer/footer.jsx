                ...
                <AnimationContainer>
                    <div className="footer__seccion">
                        ...
                        <nav className="sociales">
                            <a href="https://www.facebook.com/miranda.cruz.9849" target="_blank" className="sociales__enlace anim">
                                <span className="sociales__accesible">Facebook</span>
                            </a>
                            <a href="https://twitter.com/?lang=es" target="_blank" className="sociales__enlace anim">
                                <span className="sociales__accesible">Twitter</span>
                            </a>
                            <a href="https://www.instagram.com/" target="_blank" className="sociales__enlace anim">
                                <span className="sociales__accesible">Instagram</span>
                            </a>
                            <a href="https://www.youtube.com/" target="_blank" className="sociales__enlace anim">
                                <span className="sociales__accesible">Youtube</span>
                            </a>
                            <a href="https://www.tiktok.com/es/" target="_blank" className="sociales__enlace anim">
